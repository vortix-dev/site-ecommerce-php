...
<br><br>
<div style="padding-top:10px;" class="container card">
        <table class="table table-striped table-bordered table-hover" collspacing="0">
            ...
            <tbody>
                <tr>
                    ...
                    <input type="submit" class="update-qty-btn btn btn-primary" value="Update" >
...
<div style="width:97%" class="row text-center">
    <div class="col-md-6">
